...
//        redisTemplate.delete(keys);
    ...
    @GetMapping({"/{id}"})
    public R<DishDto> getFoodList(@PathVariable Long id) {
...
//        redisTemplate.delete(keys);
    ...
    public R<String> stopDish(@PathVariable int status, String[] ids) {
        for (String id : ids) {
...
//    }
    ...
    public R<List<DishDto>> list(Dish dish, String name) {
        ...
        List<Dish> list = dishService.list(queryWrapper);
            ...
            LambdaQueryWrapper<DishFlavor> dishFlavorshLambdaQueryWrapper = new LambdaQueryWrapper<>();
            List<DishFlavor> dishFlavorList = dishFlavorService.list(dishFlavorshLambdaQueryWrapper.eq(DishFlavor::getDishId, dishId));
